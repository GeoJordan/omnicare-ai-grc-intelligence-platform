...
<head>
    <title>Code coverage report for src/dev-server/config.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../index.html">All files</a> / <a href="index.html">src/dev-server</a> config.ts</h1>
        <div class='clearfix'>
...
<span class="cline-any cline-yes">5x</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">export interface ProxyItem {
  from: string;
  to: string;
...
export const normalize = (
  ...
  <span class="missing-if-branch" title="if path not taken" >I</span>if (config.silent) <span class="cstat-no" title="statement not covered" >config.server.logger = false;</span>
  return config;
};
&nbsp;</pre></td></tr></table></pre>
