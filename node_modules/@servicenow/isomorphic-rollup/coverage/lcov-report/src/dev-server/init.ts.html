...
<head>
    <title>Code coverage report for src/dev-server/init.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../index.html">All files</a> / <a href="index.html">src/dev-server</a> init.ts</h1>
        <div class='clearfix'>
...
export async function init(
  config: Partial&lt;DevServerConfig&gt; = <span class="branch-0 cbranch-no" title="branch not covered" >{},</span>
): Promise&lt;any&gt; {
  ...
  <span class="missing-if-branch" title="if path not taken" >I</span>if (config.extend) <span class="cstat-no" title="statement not covered" >await server.register(config.extend as any, config);</span>
  await server.ready();
  return server;
}
&nbsp;</pre></td></tr></table></pre>
