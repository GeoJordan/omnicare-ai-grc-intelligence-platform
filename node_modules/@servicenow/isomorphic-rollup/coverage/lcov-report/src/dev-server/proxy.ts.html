...
<head>
    <title>Code coverage report for src/dev-server/proxy.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../index.html">All files</a> / <a href="index.html">src/dev-server</a> proxy.ts</h1>
        <div class='clearfix'>
...
const createProxy =
  ...
  ({ from, to, opts }: ProxyItem): void =&gt; {
    <span class="missing-if-branch" title="if path not taken" >I</span>if (!silent) <span class="cstat-no" title="statement not covered" >logProxy(from, to);</span>
    const prefix = from.endsWith("/") ? <span class="branch-0 cbranch-no" title="branch not covered" >from.slice(0, -1) </span>: from;
...
export default fp(
  async (
    ...
    {
      proxy = [],
      silent = <span class="branch-0 cbranch-no" title="branch not covered" >false,</span>
      httpProxy,
