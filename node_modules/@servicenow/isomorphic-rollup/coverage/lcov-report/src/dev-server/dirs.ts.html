...
<head>
    <title>Code coverage report for src/dev-server/dirs.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../index.html">All files</a> / <a href="index.html">src/dev-server</a> dirs.ts</h1>
        <div class='clearfix'>
...
export default fp(
  async (
    ...
    <span class="missing-if-branch" title="if path not taken" >I</span>if (!silent) <span class="cstat-no" title="statement not covered" >root.forEach(logDir);</span>
