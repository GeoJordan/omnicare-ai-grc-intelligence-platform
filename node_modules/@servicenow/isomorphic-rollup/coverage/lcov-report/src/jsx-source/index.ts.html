...
<head>
    <title>Code coverage report for src/jsx-source/index.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../index.html">All files</a> / <a href="index.html">src/jsx-source</a> index.ts</h1>
        <div class='clearfix'>
...
&nbsp;
      ...
      const sep = id.includes("/") ? "/" : <span class="branch-1 cbranch-no" title="branch not covered" >"\\";</span>
      const rootWithSep = rootDir.endsWith(sep) ? <span class="branch-0 cbranch-no" title="branch not covered" >rootDir </span>: rootDir + sep;
...
&nbsp;
      const baseOffset: number = program.span?.start ?? <span class="branch-1 cbranch-no" title="branch not covered" >0;</span>
&nbsp;
...
&nbsp;
        <span class="missing-if-branch" title="if path not taken" >I</span>if (!Array.isArray(jsxNode.attributes)) <span class="cstat-no" title="statement not covered" >jsxNode.attributes = [];</span>
