...
<head>
    <title>Code coverage report for src/sn-translate/index.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../index.html">All files</a> / <a href="index.html">src/sn-translate</a> index.ts</h1>
        <div class='clearfix'>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">import type { Plugin, ModuleInfo, OutputBundle } from "rollup";
&nbsp;
...
function walk(
  ...
  <span class="missing-if-branch" title="if path not taken" >I</span>if (!node || typeof node !== "object") <span class="cstat-no" title="statement not covered" >return;</span>
      ...
      walk(moduleInfo.ast, (node) =&gt; {
        ...
        if (firstArg?.["type"] === "Literal" &amp;&amp; firstArg["value"]) {
          ...
          const properties = firstArg["properties"] as
            | Array&lt;Record&lt;string, unknown&gt;&gt;
            | undefined;
          <span class="missing-if-branch" title="if path not taken" >I</span>if (!properties) <span class="cstat-no" title="statement not covered" >return;</span>
          const obj: Record&lt;string, string&gt; = {};
          for (const prop of properties) {
            <span class="missing-if-branch" title="if path not taken" >I</span>if (prop["type"] !== "Property") <span class="cstat-no" title="statement not covered" >continue;</span>
            ...
            <span class="missing-if-branch" title="else path not taken" >E</span>if (k !== undefined &amp;&amp; typeof v === "string") obj[k] = v;
          }
          <span class="missing-if-branch" title="else path not taken" >E</span>if (Object.keys(obj).length &gt; 0)
