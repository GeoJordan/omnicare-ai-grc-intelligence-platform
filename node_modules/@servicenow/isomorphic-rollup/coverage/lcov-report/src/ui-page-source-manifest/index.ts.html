...
&nbsp;
          <span class="missing-if-branch" title="if path not taken" >I</span>if (moduleId.startsWith("\0")) <span class="cstat-no" title="statement not covered" >continue;</span>
...
&nbsp;
      for (const output of Object.values(bundle)) {
        if (output.type === "asset") {
           ...
           *
           */
          <span class="missing-if-branch" title="else path not taken" >E</span>if (output.fileName.endsWith(".html")) {
            htmlFiles.push(output.fileName);
          }
          continue;
        }
&nbsp;
        <span class="missing-if-branch" title="if path not taken" >I</span>if (output.type !== "chunk") <span class="cstat-no" title="statement not covered" >continue;</span>
...
&nbsp;
      ...
      for (const output of Object.values(bundle)) {
        ...
        const hash = hashMatch ? hashMatch[1] : <span class="branch-1 cbranch-no" title="branch not covered" >"";</span>
        vendors.push([output.fileName, hash]);
      }
      vendors.sort(<span class="fstat-no" title="function not covered" >(a</span>, b) =&gt; <span class="cstat-no" title="statement not covered" >a[0].localeCompare(b[0], "en"))</span>;
&nbsp;
...
&nbsp;
        ...
        const entryPoint = entryToFacadePath.get(firstEntryName) || <span class="branch-1 cbranch-no" title="branch not covered" >"";</span>
&nbsp;
