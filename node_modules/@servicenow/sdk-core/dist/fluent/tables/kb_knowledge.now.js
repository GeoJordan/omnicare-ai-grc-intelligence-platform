...
exports.kb_knowledge = void 0;
const db_1 = require("../../db");
exports.kb_knowledge = (0, db_1.Table)({
    ...
    schema: {
        ...
        disable_suggesting: (0, db_1.BooleanColumn)({
            default: false,
            label: [
                {
        ...
        generated_with_now_assist: (0, db_1.BooleanColumn)({
            default: false,
            label: 'Generated With Now Assist',
            readOnly: true,
        }),
        ...
        can_read_user_criteria: (0, db_1.ListColumn)({
            attributes: {
                no_sort: true,
        ...
        kb_knowledge_base: (0, db_1.ReferenceColumn)({
            attributes: {
                readonly_clickthrough: true,
            },
        ...
        meta_description: (0, db_1.StringColumn)({
            attributes: {
                no_text_index: true,
            },
        ...
        article_type: (0, db_1.StringColumn)({
            default: 'text',
        ...
        replacement_article: (0, db_1.ReferenceColumn)({
            attributes: {
                encode_utf8: false,
            },
            label: [
        ...
        scheduled_publish_date: (0, db_1.DateTimeColumn)({
            label: [
                {
        ...
        base_version: (0, db_1.ReferenceColumn)({
            attributes: {
                encode_utf8: false,
                readonly_clickthrough: true,
            },
        ...
        display_number: (0, db_1.StringColumn)({
	...
	return current.number+version;  // return the calculated value
        ...
        latest_aqi: (0, db_1.ReferenceColumn)({
            attributes: {
                encode_utf8: false,
                readonly_clickthrough: true,
            },
        ...
        summary: (0, db_1.ReferenceColumn)({
            attributes: {
                encode_utf8: false,
                readonly_clickthrough: true,
            },
        ...
        revised_by: (0, db_1.ReferenceColumn)({
            attributes: {
                encode_utf8: false,
            },
            label: 'Revised By',
        ...
        article_id: (0, db_1.StringColumn)({
            label: 'Article ID',
            maxLength: 32,
            readOnly: true,
        }),
        version: (0, db_1.ReferenceColumn)({
            attributes: {
                encode_utf8: false,
            },
            label: 'Version',
        ...
        ownership_group: (0, db_1.ReferenceColumn)({
            attributes: {
                encode_utf8: false,
            },
        ...
        latest: (0, db_1.BooleanColumn)({
            default: true,
            label: 'Latest',
            readOnly: true,
        }),
        published: (0, db_1.DateColumn)({
            label: [
                {
        ...
        display_attachments: (0, db_1.BooleanColumn)({
            default: false,
            label: [
                {
        ...
        workflow_state: (0, db_1.GenericColumn)({
            attributes: {
                ignore_filter_on_new: true,
            },
            columnType: 'workflow',
        ...
        kb_category: (0, db_1.ReferenceColumn)({
            attributes: {
                encode_utf8: false,
        ...
        helpful_count: (0, db_1.IntegerColumn)({
            default: '0',
            label: [
                {
        ...
        disable_commenting: (0, db_1.BooleanColumn)({
            default: false,
            label: [
                {
        ...
        instrumentation_metadata: (0, db_1.JsonColumn)({
            label: 'Instrumentation metadata',
            maxLength: 8000,
            readOnly: true,
        }),
        ...
        use_count: (0, db_1.IntegerColumn)({
            default: '0',
            label: [
                {
        ...
        view_as_allowed: (0, db_1.BooleanColumn)({
            default: true,
            label: [
                {
        ...
        editor_type: (0, db_1.ChoiceColumn)({
            default: 'TinyMCE',
            dropdown: 'dropdown_without_none',
            label: 'Editor Type',
        }),
        ...
        sys_view_count: (0, db_1.IntegerColumn)({
            default: '0',
            label: [
                {
        ...
        cannot_read_user_criteria: (0, db_1.ListColumn)({
            attributes: {
                no_sort: true,
                slushbucket_ref_no_expand: true,
            },
...
//# sourceMappingURL=kb_knowledge.now.js.map