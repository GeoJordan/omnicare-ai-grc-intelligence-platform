...
exports.change_request = (0, db_1.Table)({
    ...
    schema: {
        ...
        cab_required: (0, db_1.BooleanColumn)({
            default: false,
            label: [
                {
        ...
        on_hold_task: (0, db_1.ListColumn)({
            attributes: {
                no_sort: true,
        ...
        phase_state: (0, db_1.StringColumn)({
            default: 'open',
            dropdown: 'dropdown_with_none',
            dependent: 'phase',
            label: [
        ...
        production_system: (0, db_1.BooleanColumn)({
            label: 'Production system',
        }),
        end_date: (0, db_1.DateTimeColumn)({
            label: 'Planned end date',
        }),
        review_comments: (0, db_1.StringColumn)({
        ...
        requested_by_date: (0, db_1.DateTimeColumn)({
            label: 'Requested by date',
        }),
        review_date: (0, db_1.DateColumn)({
            label: 'Review date',
        }),
        risk_impact_analysis: (0, db_1.StringColumn)({
            label: [
                {
        ...
        std_change_producer_version: (0, db_1.ReferenceColumn)({
            attributes: {
                encode_utf8: false,
            },
        ...
        conflict_last_run: (0, db_1.DateTimeColumn)({
        ...
        cab_date_time: (0, db_1.DateTimeColumn)({
            label: [
                {
        ...
        backout_plan: (0, db_1.StringColumn)({
            label: [
                {
        ...
        on_hold_reason: (0, db_1.StringColumn)({
            label: [
                {
        ...
        risk: (0, db_1.IntegerColumn)({
            attributes: {
                field_decorations: 'change_risk_details',
            },
            dropdown: 'dropdown_with_none',
            label: [
                {
        ...
        cab_recommendation: (0, db_1.StringColumn)({
            label: [
                {
        ...
        change_plan: (0, db_1.StringColumn)({
            label: 'Change plan',
            maxLength: 4000,
            spellCheck: true,
        }),
        unauthorized: (0, db_1.BooleanColumn)({
            label: [
                {
        ...
        review_status: (0, db_1.IntegerColumn)({
            dropdown: 'dropdown_with_none',
            label: 'Review status',
        }),
        copied_from: (0, db_1.ReferenceColumn)({
            attributes: {
                encode_utf8: false,
            },
            label: 'Copied from',
        ...
        cab_delegate: (0, db_1.ReferenceColumn)({
            attributes: {
                encode_utf8: false,
            },
            label: [
        ...
        implementation_plan: (0, db_1.StringColumn)({
            label: [
                {
        ...
        close_code: (0, db_1.StringColumn)({
            dropdown: 'dropdown_with_none',
            label: 'Close code',
        }),
        outside_maintenance_schedule: (0, db_1.BooleanColumn)({
            label: 'Outside maintenance schedule',
        }),
        chg_model: (0, db_1.ReferenceColumn)({
            attributes: {
                encode_utf8: false,
            },
        ...
        requested_by: (0, db_1.ReferenceColumn)({
            attributes: {
                encode_utf8: false,
            },
        ...
        conflict_status: (0, db_1.StringColumn)({
            default: 'Not Run',
            choices: {
                Conflict: {
                    label: 'Conflict',
...
//# sourceMappingURL=change_request.now.js.map