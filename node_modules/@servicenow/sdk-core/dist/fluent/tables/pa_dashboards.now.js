...
exports.pa_dashboards = void 0;
const db_1 = require("../../db");
exports.pa_dashboards = (0, db_1.Table)({
    ...
    schema: {
        ...
        is_breakdown: (0, db_1.BooleanColumn)({
            default: false,
            label: [
                {
        ...
        breakdown_source: (0, db_1.ReferenceColumn)({
            attributes: {
                encode_utf8: false,
            },
        ...
        managed_breakdown: (0, db_1.ReferenceColumn)({
            attributes: {
                encode_utf8: false,
            },
        ...
        managed_publisher: (0, db_1.ReferenceColumn)({
            label: 'Act as filter',
            referenceTable: 'sys_ui_hp_publisher',
        }),
        role_override: (0, db_1.BooleanColumn)({
            default: true,
            label: 'Visible by all roles',
        }),
        ...
        disable_multiple_element: (0, db_1.BooleanColumn)({
            default: false,
            label: [
                {
        ...
        visible_to: (0, db_1.IntegerColumn)({
            default: '2',
            dropdown: 'dropdown_without_none',
            label: 'Visible to',
        }),
        groups: (0, db_1.ListColumn)({
            attributes: {
                no_sort: true,
        ...
        restrict_to_roles: (0, db_1.UserRolesColumn)({
            array: true,
        }),
        should_migrate_permissions: (0, db_1.BooleanColumn)({
            default: false,
            label: 'Should migrate permissions',
        }),
        color: (0, db_1.StringColumn)({
            label: [
                {
        ...
        notification_text: (0, db_1.TranslatedFieldColumn)({
            label: [
                {
        ...
        notification_link_url: (0, db_1.StringColumn)({
            label: [
                {
        ...
        notification_link_label: (0, db_1.TranslatedFieldColumn)({
            label: [
                {
        ...
        experience_dashboard: (0, db_1.ReferenceColumn)({
            attributes: {
                encode_utf8: false,
            },
        ...
        no_bulk_migration: (0, db_1.BooleanColumn)({
            default: false,
            label: 'Do not migrate in bulk',
        }),
...
//# sourceMappingURL=pa_dashboards.now.js.map