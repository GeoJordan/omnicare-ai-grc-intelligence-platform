...
exports.cmdb_model = void 0;
const db_1 = require("../../db");
exports.cmdb_model = (0, db_1.Table)({
    ...
    schema: {
        ...
        typical_energy_consumption: (0, db_1.DecimalColumn)({
            scale: 7,
            label: [
                {
        ...
        cmdb_ci_class: (0, db_1.StringColumn)({
            label: [
                {
                    hint: '--- Deprecated ---',
                    label: 'CMDB CI class',
        ...
        product_catalog_item: (0, db_1.ReferenceColumn)({
            attributes: {
        ...
        flow_rate: (0, db_1.IntegerColumn)({
            label: [
                {
        ...
        transportation_emission: (0, db_1.DecimalColumn)({
            scale: 7,
            label: [
                {
        ...
        cmdb_model_category: (0, db_1.ListColumn)({
            attributes: {
                no_sort: true,
        ...
        expected_lifetime_co2e: (0, db_1.StringColumn)({
            label: [
                {
        ...
        weight_decimal: (0, db_1.DecimalColumn)({
            label: [
                {
        ...
        eol_emission: (0, db_1.DecimalColumn)({
            scale: 7,
            label: [
                {
        ...
        asset_tracking_strategy: (0, db_1.StringColumn)({
        ...
        energy_star: (0, db_1.BooleanColumn)({
            default: false,
            label: [
                {
        ...
        rated_power: (0, db_1.DecimalColumn)({
            label: [
                {
        ...
        unit_of_measure_system: (0, db_1.ChoiceColumn)({
            default: 'us imperial',
            dropdown: 'dropdown_without_none',
            label: [
                {
        ...
        energy_use: (0, db_1.StringColumn)({
            label: [
                {
                    hint: 'Energy use',
                    label: 'Energy use',
        ...
        weight_unit: (0, db_1.ChoiceColumn)({
            dropdown: 'dropdown_with_none',
        ...
        volume_unit: (0, db_1.ChoiceColumn)({
            dropdown: 'dropdown_with_none',
            dependent: 'unit_of_measure_system',
            label: [
                {
        ...
        main_component: (0, db_1.ReferenceColumn)({
            attributes: {
                encode_utf8: false,
                readonly_clickthrough: true,
            },
        ...
        asset_tracking_unit: (0, db_1.ReferenceColumn)({
            attributes: {
                encode_utf8: false,
                readonly_clickthrough: true,
            },
        ...
        rack_units: (0, db_1.IntegerColumn)({
            default: '1',
            label: [
                {
        ...
        power_unit: (0, db_1.ChoiceColumn)({
            dropdown: 'dropdown_with_none',
            label: [
                {
        ...
        expected_lifespan: (0, db_1.DecimalColumn)({
            scale: 2,
            label: [
                {
        ...
        power_consumption: (0, db_1.IntegerColumn)({
            label: [
                {
        ...
        voltage_unit: (0, db_1.ChoiceColumn)({
            dropdown: 'dropdown_with_none',
            label: [
                {
        ...
        manufacturing_emission: (0, db_1.DecimalColumn)({
            scale: 7,
            label: [
                {
        ...
        sound_power: (0, db_1.IntegerColumn)({
            label: [
                {
        ...
        dimensions_unit: (0, db_1.ChoiceColumn)({
            dropdown: 'dropdown_with_none',
            dependent: 'unit_of_measure_system',
            label: [
                {
        ...
        current_unit: (0, db_1.ChoiceColumn)({
            dropdown: 'dropdown_with_none',
            label: [
                {
        ...
        usage_emission: (0, db_1.DecimalColumn)({
            scale: 7,
            label: [
                {
...
//# sourceMappingURL=cmdb_model.now.js.map