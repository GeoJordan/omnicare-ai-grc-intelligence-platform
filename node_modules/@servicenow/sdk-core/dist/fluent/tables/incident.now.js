...
exports.incident = (0, db_1.Table)({
    ...
    name: 'incident',
    schema: {
        incident_state: (0, db_1.IntegerColumn)({
            default: '1',
        ...
        origin_table: (0, db_1.TableNameColumn)({
            attributes: {
                base_start: true,
            },
            label: [
        ...
        caller_id: (0, db_1.ReferenceColumn)({
            attributes: {
                encode_utf8: false,
        ...
        reopened_time: (0, db_1.DateTimeColumn)({
        ...
        calendar_stc: (0, db_1.IntegerColumn)({
            attributes: {
        ...
        parent_incident: (0, db_1.ReferenceColumn)({
            attributes: {
                encode_utf8: false,
            },
            label: [
        ...
        problem_id: (0, db_1.ReferenceColumn)({
            attributes: {
                encode_utf8: false,
            },
            label: [
        ...
        caused_by: (0, db_1.ReferenceColumn)({
            attributes: {
                encode_utf8: false,
            },
            label: [
        ...
        business_stc: (0, db_1.IntegerColumn)({
            attributes: {
                ignore_filter_on_new: true,
            },
            label: [
        ...
        origin_id: (0, db_1.DocumentIdColumn)({
            dependent: 'origin_table',
            label: 'Origin',
        }),
        ...
        business_impact: (0, db_1.StringColumn)({
            label: 'Business impact',
            maxLength: 4000,
        }),
        hold_reason: (0, db_1.IntegerColumn)({
            dropdown: 'dropdown_with_none',
            label: 'On hold reason',
        }),
        child_incidents: (0, db_1.IntegerColumn)({
            default: '0',
            label: [
                {
...
//# sourceMappingURL=incident.now.js.map