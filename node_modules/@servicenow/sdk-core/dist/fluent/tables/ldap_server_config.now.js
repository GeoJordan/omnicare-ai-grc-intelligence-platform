...
exports.ldap_server_config = void 0;
const db_1 = require("../../db");
exports.ldap_server_config = (0, db_1.Table)({
    ...
    schema: {
        ...
        dn_field: (0, db_1.FieldNameColumn)({
            attributes: {
                allow_null: true,
                table: 'sys_user',
            },
        ...
        listen_interval: (0, db_1.IntegerColumn)({
            default: '5',
            label: [
                {
        ...
        system_id: (0, db_1.StringColumn)({
            label: 'System ID',
            maxLength: 100,
        }),
        read_timeout: (0, db_1.IntegerColumn)({
            default: '30',
            label: [
                {
        ...
        server_url: (0, db_1.StringColumn)({
        ...
        connect_timeout: (0, db_1.IntegerColumn)({
            default: '10',
            label: [
                {
        ...
        password: (0, db_1.Password2Column)({
            attributes: {
                is_legacy_password2: true,
                no_data_replicate: true,
            },
            label: [
                {
        ...
        authenticate: (0, db_1.BooleanColumn)({
            default: true,
            label: [
                {
...
//# sourceMappingURL=ldap_server_config.now.js.map