...
exports.wf_context = void 0;
const db_1 = require("../../db");
exports.wf_context = (0, db_1.Table)({
    ...
    attributes: {
        scope_master: 'workflow',
    },
    label: 'Workflow context',
    name: 'wf_context',
    schema: {
        ended: (0, db_1.DateTimeColumn)({
            label: [
                {
        ...
        after_business_rules: (0, db_1.BooleanColumn)({
            default: false,
            label: [
                {
        ...
        running_duration: (0, db_1.DurationColumn)({
            label: [
                {
        ...
        auto_start: (0, db_1.BooleanColumn)({
            label: 'Auto start',
        }),
        cumulated_avg_ert: (0, db_1.BooleanColumn)({
            label: [
                {
        ...
        scratchpad: (0, db_1.NameValuePairsColumn)({
            label: [
                {
        ...
        without_current_wf_actions: (0, db_1.GenericColumn)({
            attributes: {
                no_sort: true,
        ...
        activity_count: (0, db_1.IntegerColumn)({
            default: '0',
            label: [
                {
        ...
        stage_state: (0, db_1.StringColumn)({
            label: [
                {
                    label: 'Stage states',
                    plural: 'Stage stages',
        ...
        ert_outlier_workflow_actions: (0, db_1.GenericColumn)({
            attributes: {
                no_sort: true,
                slushbucket_ref_no_expand: true,
            },
        ...
        workflow_version: (0, db_1.ReferenceColumn)({
            attributes: {
                encode_utf8: false,
            },
            label: [
        ...
        ert_long_running_actions: (0, db_1.GenericColumn)({
            attributes: {
                no_sort: true,
                slushbucket_ref_no_expand: true,
            },
        ...
        activity_index: (0, db_1.IntegerColumn)({
            default: '0',
            label: [
                {
        ...
        column_renderer: (0, db_1.ReferenceColumn)({
            attributes: {
                encode_utf8: false,
            },
            dropdown: 'dropdown_without_none',
        ...
        started_by: (0, db_1.ReferenceColumn)({
            attributes: {
                encode_utf8: false,
            },
            cascadeRule: 'none',
        ...
        requires_ert: (0, db_1.BooleanColumn)({
            default: false,
            label: [
                {
        ...
        parent_activity: (0, db_1.ReferenceColumn)({
            attributes: {
                encode_utf8: false,
            },
        ...
        return_value: (0, db_1.NameValuePairsColumn)({
            label: [
                {
...
//# sourceMappingURL=wf_context.now.js.map