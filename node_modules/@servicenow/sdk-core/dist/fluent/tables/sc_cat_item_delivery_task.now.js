...
exports.sc_cat_item_delivery_task = void 0;
const db_1 = require("../../db");
exports.sc_cat_item_delivery_task = (0, db_1.Table)({
    ...
    schema: {
        condition: (0, db_1.ConditionsColumn)({
            attributes: {
                remoteDependent: 'delivery_plan.task_table',
            },
            label: 'Condition',
        }),
        order: (0, db_1.DecimalColumn)({
            default: '100',
            label: [
                {
        ...
        generation_script: (0, db_1.GenericColumn)({
            columnType: 'script_plain',
            label: 'Generation script',
            maxLength: 4000,
        }),
        work_notes: (0, db_1.StringColumn)({
            label: [
                {
        ...
        instructions: (0, db_1.StringColumn)({
            label: [
                {
        ...
        condition_script: (0, db_1.GenericColumn)({
            columnType: 'script_plain',
...
//# sourceMappingURL=sc_cat_item_delivery_task.now.js.map