...
exports.task = (0, db_1.Table)({
    ...
    attributes: {
        'all_tables.detail_row': 'short_description',
        'all_tables.display_color': 'priority',
        'all_tables.live_feed': true,
        'all_tables.text_index_translations': true,
        extension_model: 'hierarchy',
        hasListeners: true,
        kagami_csindex_enabled: true,
        largeTable: true,
        reference_index_include: 'active',
    },
    autoNumber: {
        number: 20000,
        prefix: 'TASK',
    ...
    name: 'task',
    schema: {
        wf_activity: (0, db_1.ReferenceColumn)({
            active: false,
            attributes: {
                encode_utf8: false,
            },
        ...
        business_service: (0, db_1.ReferenceColumn)({
            attributes: {
                encode_utf8: false,
            },
            label: 'Service',
        ...
        work_notes_list: (0, db_1.ListColumn)({
            attributes: {
                array: 'denormalized',
                no_sort: true,
        ...
        variables: (0, db_1.GenericColumn)({
            active: false,
        ...
        upon_reject: (0, db_1.StringColumn)({
            default: 'cancel',
            dropdown: 'dropdown_with_none',
            label: 'Upon reject',
        }),
        work_end: (0, db_1.DateTimeColumn)({
            attributes: {
                sla_closure: true,
                timeDimension: true,
            },
        ...
        work_start: (0, db_1.DateTimeColumn)({
            attributes: {
                sla_basis: true,
                timeDimension: true,
            },
        ...
        rejection_goto: (0, db_1.ReferenceColumn)({
            active: false,
            attributes: {
                encode_utf8: false,
                ref_qual_elements: 'parent',
            },
        ...
        service_offering: (0, db_1.ReferenceColumn)({
            attributes: {
                encode_utf8: false,
            },
        ...
        delivery_task: (0, db_1.ReferenceColumn)({
            attributes: {
                encode_utf8: false,
            },
            label: 'Delivery task',
        ...
        expected_start: (0, db_1.DateTimeColumn)({
            attributes: {
                timeDimension: true,
            },
            label: 'Expected start',
        }),
        upon_approval: (0, db_1.StringColumn)({
            default: 'proceed',
            dropdown: 'dropdown_with_none',
            label: 'Upon approval',
        }),
        ...
        approval: (0, db_1.StringColumn)({
            default: 'not requested',
            dropdown: 'dropdown_without_none',
            label: 'Approval',
        }),
        calendar_duration: (0, db_1.DurationColumn)({
            label: [
                {
        ...
        knowledge: (0, db_1.BooleanColumn)({
            default: false,
            label: [
                {
        ...
        correlation_display: (0, db_1.StringColumn)({
        ...
        approval_set: (0, db_1.DateTimeColumn)({
            attributes: {
                timeDimension: true,
            },
            label: 'Approval set',
        }),
        opened_by: (0, db_1.ReferenceColumn)({
            attributes: {
                encode_utf8: false,
            },
        ...
        contact_type: (0, db_1.StringColumn)({
            attributes: {
                no_text_index: true,
            },
            dropdown: 'dropdown_with_none',
        ...
        close_notes: (0, db_1.StringColumn)({
            label: 'Close notes',
            maxLength: 4000,
            spellCheck: true,
        }),
        reassignment_count: (0, db_1.IntegerColumn)({
            default: '0',
            label: 'Reassignment count',
        }),
        due_date: (0, db_1.DateTimeColumn)({
            label: [
                {
        ...
        closed_at: (0, db_1.DateTimeColumn)({
            attributes: {
                sla_closure: 'incident',
                timeDimension: true,
            },
            label: 'Closed',
        }),
        group_list: (0, db_1.ListColumn)({
            attributes: {
                no_sort: true,
                slushbucket_ref_no_expand: true,
            },
        ...
        activity_due: (0, db_1.DueDateColumn)({
            label: [
                {
        ...
        comments_and_work_notes: (0, db_1.GenericColumn)({
        ...
        sn_ai_sentiment: (0, db_1.ReferenceColumn)({
            attributes: {
                encode_utf8: false,
        ...
        route_reason: (0, db_1.IntegerColumn)({
            dropdown: 'dropdown_with_none',
            label: 'Transfer reason',
            readOnly: true,
        }),
        task_effective_number: (0, db_1.StringColumn)({
            attributes: {
        ...
        universal_request: (0, db_1.ReferenceColumn)({
            attributes: {
                encode_utf8: false,
            },
            cascadeRule: 'none',
        ...
        cmdb_ci: (0, db_1.ReferenceColumn)({
            attributes: {
                encode_utf8: false,
        ...
        opened_at: (0, db_1.DateTimeColumn)({
            attributes: {
                sla_basis: 'incident',
                timeDimension: true,
            },
        ...
        escalation: (0, db_1.IntegerColumn)({
            default: '0',
            dropdown: 'dropdown_without_none',
            label: 'Escalation',
            readOnly: true,
        }),
        time_worked: (0, db_1.GenericColumn)({
            columnType: 'timer',
            label: 'Time worked',
        }),
        additional_assignee_list: (0, db_1.ListColumn)({
            attributes: {
                no_sort: true,
                slushbucket_ref_no_expand: true,
            },
        ...
        approval_history: (0, db_1.GenericColumn)({
            columnType: 'journal',
            label: 'Approval history',
            maxLength: 4000,
            spellCheck: true,
        }),
        business_duration: (0, db_1.DurationColumn)({
            label: [
                {
        ...
        user_input: (0, db_1.GenericColumn)({
        ...
        closed_by: (0, db_1.ReferenceColumn)({
            attributes: {
                encode_utf8: false,
            },
            label: 'Closed by',
        ...
        follow_up: (0, db_1.DateTimeColumn)({
            label: 'Follow up',
        }),
...
//# sourceMappingURL=task.now.js.map