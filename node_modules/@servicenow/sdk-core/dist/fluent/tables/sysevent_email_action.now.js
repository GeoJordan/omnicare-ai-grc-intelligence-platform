...
exports.sysevent_email_action = void 0;
const db_1 = require("../../db");
exports.sysevent_email_action = (0, db_1.Table)({
    ...
    schema: {
        ...
        collection: (0, db_1.TableNameColumn)({
            attributes: {
                allow_public: true,
            },
            label: 'Table',
        }),
        event_parm_1: (0, db_1.BooleanColumn)({
            label: [
                {
        ...
        importance: (0, db_1.StringColumn)({
        ...
        recipient_fields: (0, db_1.FieldListColumn)({
        ...
        push_message_only: (0, db_1.BooleanColumn)({
            default: false,
            label: 'Push Message Only',
        }),
        ...
        message_text: (0, db_1.GenericColumn)({
            columnType: 'email_script',
            dependent: 'collection',
            label: 'Message text',
            maxLength: 4000,
        }),
        generation_type: (0, db_1.StringColumn)({
            default: 'engine',
        ...
        send_self: (0, db_1.BooleanColumn)({
            default: true,
            label: 'Send to event creator',
        }),
        sys_version: (0, db_1.StringColumn)({
            default: '2',
            dropdown: 'dropdown_with_none',
            label: [
                {
        ...
        omit_watermark: (0, db_1.BooleanColumn)({
            default: false,
            label: [
                {
        ...
        action_update: (0, db_1.BooleanColumn)({
            label: [
                {
        ...
        recipient_groups: (0, db_1.ListColumn)({
            attributes: {
        ...
        digest_subject: (0, db_1.StringColumn)({
            label: 'Digest Subject',
            maxLength: 100,
        }),
        digest_template: (0, db_1.ReferenceColumn)({
            attributes: {
                encode_utf8: false,
            },
        ...
        digest_text: (0, db_1.GenericColumn)({
            columnType: 'email_script',
            dependent: 'collection',
            label: 'Digest Text',
            maxLength: 4000,
        }),
        digest_from: (0, db_1.StringColumn)({
            label: 'Digest From',
            maxLength: 100,
        }),
        digestable: (0, db_1.BooleanColumn)({
            default: false,
            label: [
                {
        ...
        default_digest: (0, db_1.BooleanColumn)({
            default: false,
            label: [
                {
        ...
        message_html: (0, db_1.GenericColumn)({
            attributes: {
                convert_urls: false,
            },
        ...
        include_attachments: (0, db_1.BooleanColumn)({
            label: [
                {
        ...
        style: (0, db_1.ReferenceColumn)({
            label: 'Stationery',
            referenceTable: 'sysevent_email_style',
        }),
        sms_alternate: (0, db_1.GenericColumn)({
            columnType: 'email_script',
            dependent: 'collection',
            label: 'SMS alternate',
            maxLength: 4000,
        }),
        content_type: (0, db_1.StringColumn)({
            default: 'text/html',
            dropdown: 'dropdown_without_none',
            label: [
                {
        ...
        action_insert: (0, db_1.BooleanColumn)({
            label: [
                {
        ...
        advanced_condition: (0, db_1.ScriptColumn)({
            dependent: 'collection',
            label: 'Advanced condition',
        }),
        recipient_users: (0, db_1.ListColumn)({
            attributes: {
                slushbucket_ref_no_expand: true,
            },
            label: [
        ...
        force_delivery: (0, db_1.BooleanColumn)({
            default: false,
            label: [
                {
        ...
        affected_field_on_event: (0, db_1.ChoiceColumn)({
            dropdown: 'dropdown_with_none',
            label: [
                {
        ...
        item_table: (0, db_1.TableNameColumn)({
            attributes: {
                allow_public: true,
                base_start: true,
            },
        ...
        exclude_delegates: (0, db_1.BooleanColumn)({
            default: false,
            label: [
                {
        ...
        enable_dynamic_translation: (0, db_1.BooleanColumn)({
            default: false,
            label: 'Enable Dynamic Translation',
        }),
        subscribable: (0, db_1.BooleanColumn)({
            default: false,
            label: [
                {
        ...
        event_parm_2: (0, db_1.BooleanColumn)({
            label: [
                {
        ...
        digest_separator_text: (0, db_1.GenericColumn)({
            columnType: 'email_script',
            default: '\\n--------------------------------------------------------------------------------\\n',
            dependent: 'collection',
        ...
        digest_type: (0, db_1.StringColumn)({
            default: 'single',
            dropdown: 'dropdown_without_none',
            label: [
                {
        ...
        digest_reply_to: (0, db_1.StringColumn)({
            label: 'Digest Reply To',
            maxLength: 100,
        }),
        digest_separator_html: (0, db_1.GenericColumn)({
            columnType: 'html_script',
            default: '<br><hr><br>',
            dependent: 'collection',
        ...
        default_interval: (0, db_1.ReferenceColumn)({
            attributes: {
                encode_utf8: false,
            },
            label: [
        ...
        digest_html: (0, db_1.GenericColumn)({
            attributes: {
                convert_urls: false,
            },
            columnType: 'html_script',
        ...
        message_list: (0, db_1.ListColumn)({
            attributes: {
                array: 'denormalized',
                no_sort: true,
                slushbucket_ref_no_expand: true,
...
//# sourceMappingURL=sysevent_email_action.now.js.map