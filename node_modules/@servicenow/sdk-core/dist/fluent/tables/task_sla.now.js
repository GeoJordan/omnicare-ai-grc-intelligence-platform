...
exports.task_sla = void 0;
const db_1 = require("../../db");
exports.task_sla = (0, db_1.Table)({
    ...
    name: 'task_sla',
    schema: {
        end_time: (0, db_1.DateTimeColumn)({
            label: 'Stop time',
        }),
        business_time_left: (0, db_1.DurationColumn)({
            label: 'Business time left',
            maxLength: 40,
        }),
        ...
        original_breach_time: (0, db_1.DateTimeColumn)({
            label: [
                {
        ...
        pause_duration: (0, db_1.DurationColumn)({
            label: [
                {
        ...
        percentage: (0, db_1.GenericColumn)({
            attributes: {
        ...
        time_left: (0, db_1.DurationColumn)({
            dynamicValueDefinitions: {
   ...
   answer = newDur2.getDurationValue();
        ...
        start_time: (0, db_1.DateTimeColumn)({
            default: 'javascript:gs.nowDateTime()',
            label: 'Start time',
        }),
        business_percentage: (0, db_1.GenericColumn)({
            attributes: {
                target_threshold_colors: '0:#71e279;50:#fcc742;75:#fc8a3d;100:#f95050',
            },
            columnType: 'percent_complete',
        ...
        has_breached: (0, db_1.BooleanColumn)({
            label: 'Has breached',
        }),
        ...
        planned_end_time: (0, db_1.DateTimeColumn)({
            label: [
                {
        ...
        pause_time: (0, db_1.DateTimeColumn)({
            label: 'Pause time',
        }),
   ...
   answer = newDur2.getDurationValue();
        ...
        business_pause_duration: (0, db_1.DurationColumn)({
            label: [
                {
...
//# sourceMappingURL=task_sla.now.js.map