...
exports.sys_push_notif_msg = void 0;
const db_1 = require("../../db");
exports.sys_push_notif_msg = (0, db_1.Table)({
    ...
    schema: {
        ...
        push_message_content: (0, db_1.ReferenceColumn)({
            attributes: {
                encode_utf8: false,
            },
            label: [
        ...
        push_app: (0, db_1.ReferenceColumn)({
            attributes: {
                encode_utf8: false,
            },
            label: [
        ...
        message_string: (0, db_1.StringColumn)({
            label: [
                {
...
//# sourceMappingURL=sys_push_notif_msg.now.js.map