...
exports.kb_knowledge_base = void 0;
const db_1 = require("../../db");
exports.kb_knowledge_base = (0, db_1.Table)({
    ...
    schema: {
        description: (0, db_1.TranslatedTextColumn)({
            attributes: {
        ...
        mandatory_fields: (0, db_1.SlushBucketColumn)({
        ...
        approval_description: (0, db_1.TranslatedTextColumn)({
            attributes: {
                serializer: 'com.glide.script.TranslatedTextXMLSerializer',
            },
            label: [
        ...
        kb_version: (0, db_1.ChoiceColumn)({
            default: '3',
        ...
        disable_mark_as_helpful: (0, db_1.BooleanColumn)({
            default: false,
            label: [
                {
        ...
        template: (0, db_1.TemplateValueColumn)({
            dependent: 'table',
            label: 'Set default knowledge field values',
        }),
        card_color: (0, db_1.GenericColumn)({
            columnType: 'color',
            label: [
                {
        ...
        question_annotation: (0, db_1.GenericColumn)({
            attributes: {
                encode_utf8: false,
                serializer: 'com.glide.script.TranslatedTextXMLSerializer',
            },
        ...
        checklist: (0, db_1.ReferenceColumn)({
            attributes: {
                encode_utf8: false,
            },
            label: 'Checklist',
        ...
        enable_socialqa: (0, db_1.BooleanColumn)({
            default: false,
            label: [
                {
        ...
        title: (0, db_1.TranslatedTextColumn)({
            attributes: {
                serializer: 'com.glide.script.TranslatedTextXMLSerializer',
            },
            label: [
        ...
        disable_category_editing: (0, db_1.BooleanColumn)({
            default: false,
            label: [
                {
        ...
        article_validity: (0, db_1.IntegerColumn)({
            label: [
                {
        ...
        retire_workflow: (0, db_1.ReferenceColumn)({
            active: false,
            attributes: {
                encode_utf8: false,
            },
        ...
        data_policy: (0, db_1.ReferenceColumn)({
            attributes: {
                encode_utf8: false,
            },
            label: 'Data policy',
        ...
        disable_rating: (0, db_1.BooleanColumn)({
            default: false,
            label: [
                {
        ...
        kb_retire_flow: (0, db_1.ReferenceColumn)({
            attributes: {
                encode_utf8: false,
            },
            label: 'Retire flow',
        ...
        kb_publish_flow: (0, db_1.ReferenceColumn)({
            attributes: {
                encode_utf8: false,
            },
            label: 'Publish flow',
...
//# sourceMappingURL=kb_knowledge_base.now.js.map