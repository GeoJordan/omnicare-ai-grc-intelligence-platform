...
exports.problem = (0, db_1.Table)({
    ...
    name: 'problem',
    schema: {
        major_problem: (0, db_1.BooleanColumn)({
            default: false,
            label: [
                {
        ...
        reopened_by: (0, db_1.ReferenceColumn)({
            attributes: {
                encode_utf8: false,
        ...
        reopen_count: (0, db_1.IntegerColumn)({
            attributes: {
                ignore_filter_on_new: true,
            },
            default: '0',
        ...
        confirmed_at: (0, db_1.DateTimeColumn)({
            label: 'Confirmed',
            readOnly: true,
            readOnlyOption: 'instance_configured',
        }),
        fix_by: (0, db_1.ReferenceColumn)({
            attributes: {
                encode_utf8: false,
                ignore_filter_on_new: true,
            },
        ...
        reopened_at: (0, db_1.DateTimeColumn)({
            label: 'Last reopened at',
            readOnly: true,
            readOnlyOption: 'instance_configured',
        }),
        resolved_by: (0, db_1.ReferenceColumn)({
            attributes: {
                encode_utf8: false,
                ignore_filter_on_new: true,
            },
        ...
        resolution_code: (0, db_1.ChoiceColumn)({
            attributes: {
                ignore_filter_on_new: true,
            },
        ...
        resolved_at: (0, db_1.DateTimeColumn)({
            label: 'Resolved',
            readOnly: true,
            readOnlyOption: 'instance_configured',
        }),
        fix_at: (0, db_1.DateTimeColumn)({
            label: 'Fix',
            readOnly: true,
            readOnlyOption: 'instance_configured',
        }),
        primary_known_error_article: (0, db_1.ReferenceColumn)({
            attributes: {
                encode_utf8: false,
        ...
        problem_state: (0, db_1.IntegerColumn)({
            default: '1',
            dropdown: 'dropdown_with_none',
        ...
        fix_communicated_at: (0, db_1.DateTimeColumn)({
            label: 'Fix communicated',
            readOnly: true,
            readOnlyOption: 'instance_configured',
        }),
        rfc: (0, db_1.ReferenceColumn)({
            attributes: {
                encode_utf8: false,
            },
        ...
        review_outcome: (0, db_1.StringColumn)({
            label: [
                {
        ...
        prb_model: (0, db_1.ReferenceColumn)({
            attributes: {
                encode_utf8: false,
            },
        ...
        confirmed_by: (0, db_1.ReferenceColumn)({
            attributes: {
                encode_utf8: false,
                ignore_filter_on_new: true,
            },
        ...
        known_error: (0, db_1.BooleanColumn)({
            label: [
                {
        ...
        workaround_communicated_at: (0, db_1.DateTimeColumn)({
            label: 'Workaround communicated',
            readOnly: true,
            readOnlyOption: 'instance_configured',
        }),
        fix_communicated_by: (0, db_1.ReferenceColumn)({
            attributes: {
                encode_utf8: false,
                ignore_filter_on_new: true,
            },
        ...
        first_reported_by_task: (0, db_1.ReferenceColumn)({
            attributes: {
                encode_utf8: false,
                ignore_filter_on_new: true,
            },
        ...
        cause_notes: (0, db_1.HtmlColumn)({
            label: 'Cause notes',
        }),
        related_incidents: (0, db_1.IntegerColumn)({
            default: '0',
            label: [
                {
        ...
        category: (0, db_1.ChoiceColumn)({
            dropdown: 'dropdown_with_none',
            label: 'Category',
        }),
        workaround_applied: (0, db_1.BooleanColumn)({
            default: false,
            label: 'Workaround applied',
        }),
        subcategory: (0, db_1.ChoiceColumn)({
            dropdown: 'dropdown_with_none',
            dependent: 'category',
            label: 'Subcategory',
        }),
        workaround_communicated_by: (0, db_1.ReferenceColumn)({
            attributes: {
                encode_utf8: false,
                ignore_filter_on_new: true,
            },
        ...
        workaround: (0, db_1.HtmlColumn)({
            label: 'Workaround',
        }),
        fix_notes: (0, db_1.HtmlColumn)({
            label: 'Fix notes',
        }),
    },
    textIndex: true,
});
//# sourceMappingURL=problem.now.js.map