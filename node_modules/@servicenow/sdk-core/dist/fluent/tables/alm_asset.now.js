...
exports.alm_asset = void 0;
const db_1 = require("../../db");
exports.alm_asset = (0, db_1.Table)({
    ...
    schema: {
        ...
        resold_value: (0, db_1.GenericColumn)({
            attributes: {
                no_audit: true,
                no_text_index: true,
        ...
        model_component_id: (0, db_1.ReferenceColumn)({
            attributes: {
                encode_utf8: false,
                no_audit: true,
                no_text_index: true,
        ...
        old_status: (0, db_1.StringColumn)({
            attributes: {
                no_audit: true,
                no_text_index: true,
            },
        ...
        request_line: (0, db_1.ReferenceColumn)({
            attributes: {
                encode_utf8: false,
                readonly_clickthrough: true,
            },
        ...
        depreciation_date: (0, db_1.DateTimeColumn)({
            attributes: {
                no_audit: true,
                no_text_index: true,
            },
        ...
        asset_function: (0, db_1.ChoiceColumn)({
            attributes: {
                no_text_index: true,
            },
        ...
        pre_allocated: (0, db_1.BooleanColumn)({
            attributes: {
                no_audit: true,
                no_text_index: true,
            },
        ...
        resale_price: (0, db_1.GenericColumn)({
            attributes: {
                no_audit: true,
        ...
        stockroom: (0, db_1.ReferenceColumn)({
            attributes: {
                encode_utf8: false,
                no_text_index: true,
                readonly_clickthrough: true,
        ...
        acquisition_method: (0, db_1.StringColumn)({
            attributes: {
                no_audit: true,
            },
            dropdown: 'dropdown_with_none',
        ...
        retirement_date: (0, db_1.DateColumn)({
            attributes: {
                no_text_index: true,
            },
            label: [
        ...
        residual_date: (0, db_1.DateColumn)({
            attributes: {
                no_audit: true,
                no_text_index: true,
            },
        ...
        active_to: (0, db_1.BooleanColumn)({
            attributes: {
                no_audit: true,
                no_text_index: true,
            },
        ...
        beneficiary: (0, db_1.ReferenceColumn)({
            attributes: {
                encode_utf8: false,
                no_audit: true,
                readonly_clickthrough: true,
        ...
        model_category: (0, db_1.ReferenceColumn)({
            attributes: {
                encode_utf8: false,
                readonly_clickthrough: true,
            },
        ...
        salvage_value: (0, db_1.GenericColumn)({
            attributes: {
                no_audit: true,
                no_text_index: true,
                omit_sys_original: true,
        ...
        display_name: (0, db_1.StringColumn)({
            label: [
                {
        ...
        old_substatus: (0, db_1.StringColumn)({
            attributes: {
                no_audit: true,
                no_text_index: true,
            },
        ...
        disposal_reason: (0, db_1.StringColumn)({
            attributes: {
                no_audit: true,
            },
        ...
        reserved_for: (0, db_1.ReferenceColumn)({
            attributes: {
                encode_utf8: false,
            },
            label: [
        ...
        depreciated_amount: (0, db_1.GenericColumn)({
            attributes: {
                no_audit: true,
                no_text_index: true,
                omit_sys_original: true,
        ...
        depreciation: (0, db_1.ReferenceColumn)({
            attributes: {
                encode_utf8: false,
                no_audit: true,
                no_text_index: true,
        ...
        expenditure_type: (0, db_1.StringColumn)({
            attributes: {
                no_audit: true,
            },
            choices: {
...
//# sourceMappingURL=alm_asset.now.js.map