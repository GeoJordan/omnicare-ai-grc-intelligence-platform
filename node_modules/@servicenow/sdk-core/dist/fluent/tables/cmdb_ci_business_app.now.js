...
exports.cmdb_ci_business_app = void 0;
const db_1 = require("../../db");
exports.cmdb_ci_business_app = (0, db_1.Table)({
    ...
    schema: {
        appraisal_fiscal_type: (0, db_1.ChoiceColumn)({
            attributes: {
                no_audit: true,
            },
        ...
        product_support_status: (0, db_1.ChoiceColumn)({
            attributes: {
                no_audit: true,
            },
            dropdown: 'dropdown_with_none',
        ...
        support_vendor: (0, db_1.ReferenceColumn)({
            attributes: {
                encode_utf8: false,
                no_audit: true,
        ...
        active_user_count: (0, db_1.IntegerColumn)({
            label: 'Active user count',
        }),
        next_assessment_date: (0, db_1.DateColumn)({
            attributes: {
                no_audit: true,
            },
            label: 'Next assessment date',
        }),
        data_classification: (0, db_1.ChoiceColumn)({
        ...
        business_criticality: (0, db_1.ChoiceColumn)({
            dropdown: 'dropdown_with_none',
            label: [
                {
        ...
        audience_type: (0, db_1.ChoiceColumn)({
            attributes: {
                no_audit: true,
            },
            dropdown: 'dropdown_with_none',
        ...
        application_manager: (0, db_1.ReferenceColumn)({
            attributes: {
                encode_utf8: false,
                no_audit: true,
            },
        ...
        it_application_owner: (0, db_1.ReferenceColumn)({
            attributes: {
                encode_utf8: false,
                no_audit: true,
            },
        ...
        last_change_date: (0, db_1.DateColumn)({
            label: [
                {
        ...
        platform_host: (0, db_1.ReferenceColumn)({
            attributes: {
                encode_utf8: false,
            },
            label: 'Platform Host',
        ...
        contract_end_date: (0, db_1.DateColumn)({
            label: [
                {
        ...
        architecture_type: (0, db_1.StringColumn)({
            attributes: {
                no_audit: true,
            },
            dropdown: 'dropdown_without_none',
        ...
        software_license: (0, db_1.ReferenceColumn)({
            attributes: {
                encode_utf8: false,
                no_audit: true,
            },
        ...
        work_notes: (0, db_1.GenericColumn)({
        ...
        apm_business_process: (0, db_1.ReferenceColumn)({
            attributes: {
                encode_utf8: false,
                no_audit: true,
            },
        ...
        organization_unit_count: (0, db_1.IntegerColumn)({
            attributes: {
                no_audit: true,
            },
            label: 'Organization unit count',
        }),
        ...
        install_type: (0, db_1.ChoiceColumn)({
            attributes: {
                no_audit: true,
            },
            dropdown: 'dropdown_without_none',
        ...
        emergency_tier: (0, db_1.ChoiceColumn)({
            attributes: {
                no_audit: true,
            },
            dropdown: 'dropdown_without_none',
        ...
        cmdb_software_product_model: (0, db_1.ReferenceColumn)({
            attributes: {
                encode_utf8: false,
                no_audit: true,
            },
        ...
        certified: (0, db_1.BooleanColumn)({
            attributes: {
                no_audit: true,
            },
            label: 'Certified',
        }),
        application_type: (0, db_1.ChoiceColumn)({
            attributes: {
                no_audit: true,
            },
            dropdown: 'dropdown_without_none',
        ...
        technology_stack: (0, db_1.ChoiceColumn)({
            attributes: {
                no_audit: true,
            },
            dropdown: 'dropdown_without_none',
        ...
        age_in_month: (0, db_1.StringColumn)({
            attributes: {
                no_audit: true,
            },
...
//# sourceMappingURL=cmdb_ci_business_app.now.js.map