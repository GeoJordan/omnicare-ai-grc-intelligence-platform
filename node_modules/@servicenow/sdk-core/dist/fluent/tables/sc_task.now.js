...
exports.sc_task = void 0;
const db_1 = require("../../db");
exports.sc_task = (0, db_1.Table)({
    ...
    schema: {
        ...
        cat_item: (0, db_1.ReferenceColumn)({
            attributes: {
                encode_utf8: false,
                popover: true,
        ...
        request_item: (0, db_1.ReferenceColumn)({
            attributes: {
                encode_utf8: false,
            },
            label: 'Request item',
        ...
        sc_catalog: (0, db_1.ReferenceColumn)({
            label: 'Catalog',
            readOnly: true,
            referenceTable: 'sc_catalog',
        }),
        request: (0, db_1.ReferenceColumn)({
            attributes: {
                encode_utf8: false,
...
//# sourceMappingURL=sc_task.now.js.map