...
exports.sys_script_vtable = (0, db_1.Table)({
    ...
    schema: {
        cache_isolation_level: (0, db_1.ChoiceColumn)({
            default: 'USER',
        ...
        cache_empty_query_results: (0, db_1.BooleanColumn)({
            default: true,
        ...
        enhanced_capacity: (0, db_1.BooleanColumn)({
            default: false,
        ...
        cache_ttl: (0, db_1.IntegerColumn)({
            default: '0',
            label: [
                {
        ...
        delete_script: (0, db_1.GenericColumn)({
            columnType: 'script_plain',
        ...
        insert_script: (0, db_1.GenericColumn)({
            columnType: 'script_plain',
        ...
        update_script: (0, db_1.GenericColumn)({
            columnType: 'script_plain',
        ...
        cache_strategy: (0, db_1.ChoiceColumn)({
            default: 'CACHE_BY_QUERY',
            dropdown: 'dropdown_without_none',
            label: 'Caching Strategy',
            readOnly: true,
        }),
        flow: (0, db_1.ReferenceColumn)({
            attributes: {
                allow_public: true,
                encode_utf8: false,
