...
exports.sys_ui_list_control = void 0;
const db_1 = require("../../db");
exports.sys_ui_list_control = (0, db_1.Table)({
    ...
    schema: {
        omit_related_list_count: (0, db_1.BooleanColumn)({
            label: [
                {
        ...
        hierarchical_lists: (0, db_1.BooleanColumn)({
            label: [
                {
        ...
        omit_count_views_list: (0, db_1.ListColumn)({
            attributes: {
                array: 'denormalized',
                no_sort: true,
        ...
        omit_count: (0, db_1.BooleanColumn)({
            label: [
                {
        ...
        edit_default_filter: (0, db_1.ConditionsColumn)({
            label: 'Edit default filter',
        }),
        omit_columns_if_empty: (0, db_1.BooleanColumn)({
            label: [
                {
        ...
        edit_condition: (0, db_1.GenericColumn)({
        ...
        filter_roles: (0, db_1.UserRolesColumn)({
            array: true,
            label: [
                {
        ...
        sys_overrides: (0, db_1.ReferenceColumn)({
            default: 'global',
            label: [
                {
        ...
        omit_links: (0, db_1.BooleanColumn)({
            label: [
                {
        ...
        omit_if_empty: (0, db_1.BooleanColumn)({
            label: [
                {
        ...
        columns_condition: (0, db_1.GenericColumn)({
            columnType: 'script_plain',
            label: [
                {
        ...
        filter_condition: (0, db_1.GenericColumn)({
            columnType: 'script_plain',
            label: [
                {
        ...
        edit_roles: (0, db_1.UserRolesColumn)({
            array: true,
            label: [
                {
        ...
        omit_filters: (0, db_1.BooleanColumn)({
            label: [
                {
        ...
        omit_count_views: (0, db_1.BooleanColumn)({
            label: [
                {
        ...
        disable_nlq: (0, db_1.BooleanColumn)({
            label: [
                {
        ...
        related_list: (0, db_1.StringColumn)({
            label: 'Related list',
            maxLength: 160,
            readOnly: true,
        }),
        empty_condition: (0, db_1.GenericColumn)({
            columnType: 'script_plain',
            label: [
                {
        ...
        link_condition: (0, db_1.GenericColumn)({
            columnType: 'script_plain',
            label: [
                {
        ...
        new_roles: (0, db_1.UserRolesColumn)({
            array: true,
            label: [
                {
        ...
        list_edit_insert_row: (0, db_1.BooleanColumn)({
            default: false,
            label: [
                {
        ...
        omit_edit_button: (0, db_1.BooleanColumn)({
            default: true,
            label: [
                {
        ...
        omit_drilldown_link: (0, db_1.BooleanColumn)({
            label: [
                {
        ...
        new_condition: (0, db_1.GenericColumn)({
            columnType: 'script_plain',
            label: [
                {
                    hint: 'If condition evaluates true, omit button',
        ...
        link_roles: (0, db_1.UserRolesColumn)({
            array: true,
            label: [
                {
        ...
        list_edit_type: (0, db_1.StringColumn)({
            choices: {
                save_by_row: {
        ...
        label: (0, db_1.TranslatedFieldColumn)({
            label: [
                {
        ...
        list_edit_ref_qual_tag: (0, db_1.StringColumn)({
            label: [
                {
        ...
        omit_new_button: (0, db_1.BooleanColumn)({
            label: [
                {
...
//# sourceMappingURL=sys_ui_list_control.now.js.map