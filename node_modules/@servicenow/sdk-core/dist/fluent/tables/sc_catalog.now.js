...
exports.sc_catalog = void 0;
const db_1 = require("../../db");
exports.sc_catalog = (0, db_1.Table)({
    ...
    schema: {
        ...
        desktop_image: (0, db_1.GenericColumn)({
            attributes: {
                pdf_cell_type: 'image',
            },
        ...
        desktop_continue_shopping: (0, db_1.StringColumn)({
            label: [
                {
        ...
        desktop_home_page: (0, db_1.StringColumn)({
            label: [
                {
        ...
        enable_wish_list: (0, db_1.BooleanColumn)({
            default: false,
            label: [
                {
        ...
        title: (0, db_1.TranslatedFieldColumn)({
            label: [
                {
...
//# sourceMappingURL=sc_catalog.now.js.map