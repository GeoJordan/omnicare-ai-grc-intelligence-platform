...
exports.sys_data_source = void 0;
const db_1 = require("../../db");
exports.sys_data_source = (0, db_1.Table)({
    ...
    schema: {
        csv_delimiter: (0, db_1.StringColumn)({
            choices: {
                ',': {
                    label: ',',
                },
        ...
        jdbc_server: (0, db_1.StringColumn)({
            label: [
                {
        ...
        ldapprobe_result_set_rows: (0, db_1.IntegerColumn)({
            default: '200',
            label: [
                {
        ...
        type: (0, db_1.StringColumn)({
            ...
            choices: {
                ...
                REST: {
                    label: 'REST (IntegrationHub)',
                    sequence: 50,
                },
                CUSTOM: {
                    label: 'Custom (Load by Script)',
                    sequence: 70,
                },
            },
        ...
        connection_timeout: (0, db_1.IntegerColumn)({
            default: '0',
            label: [
                {
        ...
        sql_statement: (0, db_1.StringColumn)({
            label: [
                {
        ...
        request_action: (0, db_1.ReferenceColumn)({
            attributes: {
                encode_utf8: false,
        ...
        import_set_table_label: (0, db_1.StringColumn)({
            label: [
                {
        ...
        sheet_number: (0, db_1.IntegerColumn)({
            default: '0',
            label: [
                {
        ...
        glide_keystore: (0, db_1.BooleanColumn)({
            default: false,
            label: [
                {
        ...
        last_success_import_time: (0, db_1.DateTimeColumn)({
            label: [
                {
        ...
        import_set_table_name: (0, db_1.StringColumn)({
            label: [
                {
        ...
        jpath_root_node: (0, db_1.StringColumn)({
            label: [
                {
        ...
        scp_password: (0, db_1.Password2Column)({
            attributes: {
                is_legacy_password2: true,
            },
            label: [
                {
        ...
        oracle_sid: (0, db_1.StringColumn)({
            default: 'orcl',
            label: 'Oracle sid',
        }),
        parallel_loading_script: (0, db_1.ScriptColumn)({
...
&#13;
        ...
        xpath_root_node: (0, db_1.StringColumn)({
            label: [
                {
        ...
        scp_user_name: (0, db_1.StringColumn)({
            label: [
                {
        ...
        database_port: (0, db_1.StringColumn)({
            label: [
                {
        ...
        enable_parallel_loading: (0, db_1.BooleanColumn)({
            default: false,
            label: [
                {
        ...
        jdbc_password: (0, db_1.Password2Column)({
            attributes: {
                is_legacy_password2: true,
            },
            label: [
        ...
        connection_url: (0, db_1.StringColumn)({
            attributes: {
                no_log: true,
            },
            label: [
        ...
        table_name: (0, db_1.StringColumn)({
            label: [
                {
        ...
        query_timeout: (0, db_1.IntegerColumn)({
            default: '0',
            label: [
                {
        ...
        data_in_single_column: (0, db_1.BooleanColumn)({
            default: false,
            label: [
                {
        ...
        ssh_keyfile_path: (0, db_1.StringColumn)({
            label: [
                {
        ...
        last_run_datetime: (0, db_1.StringColumn)({
            label: [
                {
        ...
        expand_node_children: (0, db_1.BooleanColumn)({
            default: false,
            label: [
                {
        ...
        use_last_run_datetime: (0, db_1.BooleanColumn)({
            default: false,
            label: [
                {
        ...
        import_connection_alias: (0, db_1.ReferenceColumn)({
            attributes: {
                encode_utf8: false,
            },
        ...
        scp_authentication: (0, db_1.StringColumn)({
        ...
        database_name: (0, db_1.StringColumn)({
            label: [
                {
        ...
        batch_size: (0, db_1.IntegerColumn)({
            default: '1000',
            label: [
                {
        ...
        parsing_script: (0, db_1.ScriptColumn)({
        ...
        connection_url_parameters: (0, db_1.StringColumn)({
            label: [
                {
        ...
        jdbc_user_name: (0, db_1.StringColumn)({
            label: [
                {
        ...
        sheet_name: (0, db_1.IntegerColumn)({
            default: '1',
            dropdown: 'dropdown_without_none',
            label: 'Sheet name',
        }),
        properties: (0, db_1.StringColumn)({
            label: [
                {
        ...
        last_run_database_field: (0, db_1.StringColumn)({
            label: [
                {
        ...
        ldap_target: (0, db_1.ReferenceColumn)({
            attributes: {
                encode_utf8: false,
            },
            label: [
        ...
        header_row: (0, db_1.IntegerColumn)({
            default: '0',
            label: [
                {
        ...
        query: (0, db_1.RadioColumn)({
            default: 'All Rows from Table',
            choices: {
                'All Rows from Table': {
                    label: 'All Rows from Table',
                },
                'Specific SQL': {
                    label: 'Specific SQL',
                },
        ...
        connection_override_last_success_time: (0, db_1.GenericColumn)({
            columnType: 'simple_name_values',
            label: 'Connection override last success time',
            maxLength: 4000,
        }),
        discard_arrays: (0, db_1.BooleanColumn)({
            default: true,
            label: [
                {
        ...
        scp_server: (0, db_1.StringColumn)({
            label: [
                {
        ...
        oracle_port: (0, db_1.StringColumn)({
            default: '1521',
            label: 'Oracle port',
        }),
        mid_server: (0, db_1.ReferenceColumn)({
            attributes: {
                encode_utf8: false,
            },
            label: [
        ...
        use_import_connection_alias: (0, db_1.BooleanColumn)({
            default: false,
            label: [
                {
        ...
        file_retrieval_method: (0, db_1.StringColumn)({
            default: 'Attachment',
            choices: {
                Attachment: {
                    label: 'Attachment',
        ...
        instance_name: (0, db_1.StringColumn)({
            label: [
                {
        ...
        use_batch_import: (0, db_1.BooleanColumn)({
            default: false,
            label: [
                {
        ...
        data_loader: (0, db_1.ScriptColumn)({
 ...
 // Add your code here to insert data to import_set_table 
        ...
        maximum_rows: (0, db_1.IntegerColumn)({
            label: [
                {
        ...
        use_integrated_authentication: (0, db_1.BooleanColumn)({
            default: false,
            label: [
                {
        ...
        support_pagination: (0, db_1.BooleanColumn)({
            default: false,
            label: [
                {
...
//# sourceMappingURL=sys_data_source.now.js.map