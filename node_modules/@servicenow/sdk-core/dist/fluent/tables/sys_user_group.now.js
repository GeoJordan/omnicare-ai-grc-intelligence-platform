...
exports.sys_user_group = void 0;
const db_1 = require("../../db");
exports.sys_user_group = (0, db_1.Table)({
    ...
    schema: {
        ...
        default_assignee: (0, db_1.ReferenceColumn)({
            label: [
                {
        ...
        include_members: (0, db_1.BooleanColumn)({
            label: [
                {
        ...
        exclude_manager: (0, db_1.BooleanColumn)({
            label: [
                {
...
//# sourceMappingURL=sys_user_group.now.js.map