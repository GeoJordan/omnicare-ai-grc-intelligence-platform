...
exports.sendEmail = (0, Action_1.Action)({
    ...
    inputs: {
        ...
        ah_bcc: (0, db_1.StringColumn)({
            label: 'BCC',
            maxLength: 8000,
        }),
        ah_subject: (0, db_1.StringColumn)({
            label: 'Subject',
            mandatory: true,
            maxLength: 8000,
        }),
        ah_body: (0, db_1.HtmlColumn)({
            label: 'Body',
            maxLength: 65536,
            columnType: 'html',
        }),
...
//# sourceMappingURL=sendEmail.now.js.map