...
/**
 * A table's schema: a map of column names to {@link Column} definitions. Defined here (rather
 ...
 */
export type TableColumn = Record<string, Column>;
...
/** @interface */
export type Column<Type = unknown, Default extends Type = Type> = Typed<Type, Now.Internal.WithMetadata<{
