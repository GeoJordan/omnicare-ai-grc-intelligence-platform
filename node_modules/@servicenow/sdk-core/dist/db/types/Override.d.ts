 ...
 *
 * @param config - an object that can include all `OverrideColumnType` properties
 *
 * @example
 * ```typescript
 ...
 * @group Table/Columns
 */
export declare function OverrideColumn(config: OverrideColumnType): OverrideColumnType;
