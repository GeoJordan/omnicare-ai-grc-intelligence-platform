...
/** @interface */
export type ClientScriptProps<T extends TableName, E extends client_script_events, G extends boolean> = Now.Internal.WithIdAndMetadata<{
     ...
     * Only effective when `global` is `false`; ignored otherwise.
     */
    view?: string;
