 ...
 * @interface
 */
export type ColumnTypeCheck = Now.Internal.WithIdAndMetadata<ScanCheckBase & {
 ...
 * @interface
 */
export type TableCheck<T extends TableName = TableName> = Now.Internal.WithIdAndMetadata<ScanCheckBase & {
    /** Table to scan */
    table: T;
 ...
 * @group InstanceScan
 */
export declare function ColumnTypeCheck(config: ColumnTypeCheck): ColumnTypeCheck;
/**
 ...
 * @group InstanceScan
 */
export declare function LinterCheck(config: LinterCheck): LinterCheck;
/**
 ...
 * @group InstanceScan
 */
export declare function ScriptOnlyCheck(config: ScriptOnlyCheck): ScriptOnlyCheck;
/**
 ...
 * @group InstanceScan
 */
export declare function TableCheck<const T extends TableName>(config: TableCheck<T>): TableCheck<T>;
export {};
