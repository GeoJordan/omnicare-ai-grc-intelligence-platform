...
type WidgetOptionType = 'string' | 'boolean' | 'integer' | 'reference' | 'choice' | 'field_list' | 'field_name' | 'glide_list' | 'glyphicon';
...
/** @interface */
export type SPWidget<Table extends TableName = 'sp_instance'> = Now.Internal.WithIdAndMetadata<{
 ...
 * @group ServicePortal
 */
export declare function SPWidget<T extends TableName = 'sp_instance'>(config: SPWidget<T>): SPWidget<T>;
export {};
