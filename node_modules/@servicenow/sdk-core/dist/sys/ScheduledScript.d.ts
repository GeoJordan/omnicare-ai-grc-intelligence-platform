 ...
 */
type RunType = 'daily' | 'day_and_month_in_year' | 'weekly' | 'monthly' | 'day_week_month_year' | 'periodically' | 'once' | 'on_demand' | 'week_in_month' | 'business_calendar_start' | 'business_calendar_end';
/** @interface */
 ...
 */
export declare function ScheduledScript(config: ScheduledScript): ScheduledScript;
export {};
