 ...
 */
export declare function EmailNotification<T extends TableName>(config: EmailNotification<T>): EmailNotification<T> & Now.Internal.TableBrand<'sysevent_email_action'>;
export {};
