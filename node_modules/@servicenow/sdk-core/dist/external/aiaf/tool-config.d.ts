...
import type { AiAgentToolRecordType, AiAgentToolType, FieldType, OutputTransformationStrategy, ToolDocumentStatus, ToolExecutionMode, RecordOperationName, SortType } from './constants';
/**
...
type GenericToolDetails = BaseToolDetails & {
    type?: Exclude<AiAgentToolType, 'crud' | 'script' | 'capability' | 'subflow' | 'action' | 'catalog' | 'topic' | 'topic_block' | 'web_automation' | 'knowledge_graph' | 'file_upload' | 'rag' | 'search_retrieval'>;
 ...
 */
export type AiAgentToolDetailsType = CrudToolDetails | ScriptToolDetails | CapabilityToolDetails | SubflowToolDetails | ActionToolDetails | CatalogToolDetails | TopicToolDetails | TopicBlockToolDetails | WebAutomationToolDetails | KnowledgeGraphToolDetails | FileUploadToolDetails | RagToolDetails | GenericToolDetails;
