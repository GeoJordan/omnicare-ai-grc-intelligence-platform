...
type FlowInstance = ReturnType<typeof Flow>;
 ...
 */
type CatalogItemConfig<V extends VariableTypes = VariableTypes> = Now.Internal.WithIdAndMetadata<CatalogItemBaseConfig<V> & FulfillmentProcess & M2MRelationships & PricingConfig & LegacyCartConfig & PortalSettingConfig & AvailabilityConfig & DeliveryConfig & CatalogItemAccessConfig>;
/** @interface */
 ...
 *
 * @param config Catalog item configuration — name, description, variables, fulfillment process, and visibility settings.
 * @see https://docs.servicenow.com/csh?topicname=service-catalog-api-now-ts.html&version=latest
 * @group ServiceCatalog
 */
export declare function CatalogItem<const V extends VariableTypes, const VSets extends NonNullable<M2MRelationships['variableSets']>>(config: CatalogItem<V> & {
    variableSets?: VSets;
}): CatalogItem<V> & {
    variables: MergedVariables<V, VSets>;
};
export declare function CatalogItem(config: CatalogItem): CatalogItem;
export {};
