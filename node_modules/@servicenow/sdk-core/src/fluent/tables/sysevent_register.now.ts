import { Table, TableNameColumn, IntegerColumn, StringColumn, GuidColumn, FloatColumn } from '../../db'

export const sysevent_register = Table({
    ...
    schema: {
        ...
        fired_by: StringColumn({
            label: 'Fired by',
            maxLength: 100,
        }),
        event_name: StringColumn({
            label: 'Event name',
        }),
    },
    textIndex: true,
