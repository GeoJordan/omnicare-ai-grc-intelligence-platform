import { Table, TableNameColumn, StringColumn, ReferenceColumn, GuidColumn } from '../../db'

export const sys_push_notif_msg = Table({
    ...
    schema: {
        ...
        push_message_content: ReferenceColumn({
            attributes: {
                encode_utf8: false,
            },
            label: [
