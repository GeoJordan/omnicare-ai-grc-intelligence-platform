import { Table, GenericColumn, StringColumn, ReferenceColumn, TableNameColumn, BooleanColumn } from '../../db'

export const sys_ui_formatter = Table({
    ...
    schema: {
        ...
        seismic_component: ReferenceColumn({
            cascadeRule: 'delete',
