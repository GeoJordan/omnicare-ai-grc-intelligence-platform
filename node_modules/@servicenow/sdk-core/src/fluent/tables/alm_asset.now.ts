...
export const alm_asset = Table({
    ...
    schema: {
        ...
        model_component_id: ReferenceColumn({
            attributes: {
                encode_utf8: false,
                no_audit: true,
                no_text_index: true,
        ...
        depreciation_date: DateTimeColumn({
            attributes: {
                no_audit: true,
                no_text_index: true,
            },
        ...
        model_category: ReferenceColumn({
            attributes: {
                encode_utf8: false,
                readonly_clickthrough: true,
            },
        ...
        depreciated_amount: GenericColumn({
            attributes: {
                no_audit: true,
                no_text_index: true,
                omit_sys_original: true,
