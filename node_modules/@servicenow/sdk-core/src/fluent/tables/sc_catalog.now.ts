...
export const sc_catalog = Table({
    ...
    schema: {
        ...
        desktop_continue_shopping: StringColumn({
            label: [
                {
        ...
        desktop_home_page: StringColumn({
            label: [
                {
        ...
        enable_wish_list: BooleanColumn({
            default: false,
            label: [
                {
