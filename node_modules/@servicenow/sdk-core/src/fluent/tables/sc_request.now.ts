import { Table, StringColumn, GenericColumn, ReferenceColumn, DateColumn, IntegerColumn, GuidColumn } from '../../db'

export const sc_request = Table({
    ...
    schema: {
        ...
        parent_interaction: ReferenceColumn({
            attributes: {
                encode_utf8: false,
            },
