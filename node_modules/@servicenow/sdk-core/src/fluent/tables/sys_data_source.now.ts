...
export const sys_data_source = Table({
    ...
    schema: {
        ...
        ldapprobe_result_set_rows: IntegerColumn({
            default: '200',
            label: [
                {
        ...
        request_action: ReferenceColumn({
            attributes: {
                encode_utf8: false,
        ...
        import_set_table_label: StringColumn({
            label: [
                {
        ...
        last_success_import_time: DateTimeColumn({
            label: [
                {
        ...
        import_set_table_name: StringColumn({
            label: [
                {
        ...
        oracle_sid: StringColumn({
            default: 'orcl',
            label: 'Oracle sid',
        }),
        parallel_loading_script: ScriptColumn({
...
&#13;
        ...
        enable_parallel_loading: BooleanColumn({
            default: false,
            label: [
                {
        ...
        data_in_single_column: BooleanColumn({
            default: false,
            label: [
                {
        ...
        last_run_datetime: StringColumn({
            label: [
                {
        ...
        expand_node_children: BooleanColumn({
            default: false,
            label: [
                {
        ...
        use_last_run_datetime: BooleanColumn({
            default: false,
            label: [
                {
        ...
        import_connection_alias: ReferenceColumn({
            attributes: {
                encode_utf8: false,
            },
        ...
        scp_authentication: StringColumn({
        ...
        connection_url_parameters: StringColumn({
            label: [
                {
        ...
        sheet_name: IntegerColumn({
            default: '1',
            dropdown: 'dropdown_without_none',
            label: 'Sheet name',
        }),
        properties: StringColumn({
            label: [
                {
        ...
        last_run_database_field: StringColumn({
            label: [
                {
        ...
        connection_override_last_success_time: GenericColumn({
            columnType: 'simple_name_values',
            label: 'Connection override last success time',
            maxLength: 4000,
        }),
        discard_arrays: BooleanColumn({
            default: true,
            label: [
                {
        ...
        use_import_connection_alias: BooleanColumn({
            default: false,
            label: [
                {
        ...
        file_retrieval_method: StringColumn({
            default: 'Attachment',
            choices: {
                Attachment: {
                    label: 'Attachment',
        ...
        use_batch_import: BooleanColumn({
            default: false,
            label: [
                {
 ...
 // Add your code here to insert data to import_set_table 
        ...
        use_integrated_authentication: BooleanColumn({
            default: false,
            label: [
                {
        ...
        support_pagination: BooleanColumn({
            default: false,
            label: [
                {
