...
export const cmdb_ci_business_app = Table({
    ...
    schema: {
        appraisal_fiscal_type: ChoiceColumn({
            attributes: {
                no_audit: true,
            },
        ...
        product_support_status: ChoiceColumn({
            attributes: {
                no_audit: true,
            },
            dropdown: 'dropdown_with_none',
        ...
        support_vendor: ReferenceColumn({
            attributes: {
                encode_utf8: false,
                no_audit: true,
        ...
        active_user_count: IntegerColumn({
            label: 'Active user count',
        }),
        next_assessment_date: DateColumn({
            attributes: {
                no_audit: true,
            },
            label: 'Next assessment date',
        }),
        data_classification: ChoiceColumn({
        ...
        business_criticality: ChoiceColumn({
            dropdown: 'dropdown_with_none',
            label: [
                {
        ...
        application_manager: ReferenceColumn({
            attributes: {
                encode_utf8: false,
                no_audit: true,
            },
        ...
        it_application_owner: ReferenceColumn({
            attributes: {
                encode_utf8: false,
                no_audit: true,
            },
        ...
        architecture_type: StringColumn({
            attributes: {
                no_audit: true,
            },
            dropdown: 'dropdown_without_none',
        ...
        software_license: ReferenceColumn({
            attributes: {
                encode_utf8: false,
                no_audit: true,
            },
        ...
        apm_business_process: ReferenceColumn({
            attributes: {
                encode_utf8: false,
                no_audit: true,
            },
        ...
        organization_unit_count: IntegerColumn({
            attributes: {
                no_audit: true,
            },
        ...
        cmdb_software_product_model: ReferenceColumn({
            attributes: {
                encode_utf8: false,
                no_audit: true,
            },
        ...
        certified: BooleanColumn({
            attributes: {
                no_audit: true,
            },
            label: 'Certified',
        }),
        application_type: ChoiceColumn({
            attributes: {
                no_audit: true,
            },
            dropdown: 'dropdown_without_none',
