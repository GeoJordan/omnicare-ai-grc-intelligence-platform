import { Table, GuidColumn, BooleanColumn, ListColumn, TranslatedTextColumn, ReferenceColumn } from '../../db'

export const sc_template = Table({
    allowWebServiceAccess: true,
    attributes: {
        domain_master: 'cat_item',
        update_synch: true,
    },
    display: 'name',
    ...
    schema: {
        ...
        allow_edit_unlisted_variables: BooleanColumn({
        ...
        use_template_scope: BooleanColumn({
