...
/** @interface */
export type Property<T extends PropertyType = PropertyType> = Now.Internal.WithIdAndMetadata<
    {
 ...
 */
export function Property<const T extends PropertyType>(config: Property<T>): Property<T> {
    return config
}
