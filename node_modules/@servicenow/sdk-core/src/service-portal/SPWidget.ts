...
type WidgetOptionChoice = { label: string; value: string }
 ...
 * @group ServicePortal
 */
export function SPWidget<T extends TableName = 'sp_instance'>(config: SPWidget<T>) {
    return config
}
