...
/** @interface */
export type SPHeaderFooter<Table extends TableName = 'sp_instance'> = SPWidget<Table> & {
    /**
 ...
 * @group ServicePortal
 */
export function SPHeaderFooter<T extends TableName = 'sp_instance'>(config: SPHeaderFooter<T>) {
    return config
}
