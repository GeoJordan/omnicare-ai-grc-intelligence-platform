...
export type EmailNotification<T extends TableName> = Now.Internal.WithIdAndMetadata<{
 ...
 */
export function EmailNotification<T extends TableName>(
    config: EmailNotification<T>
): EmailNotification<T> & Now.Internal.TableBrand<'sysevent_email_action'> {
    return config as EmailNotification<T> & Now.Internal.TableBrand<'sysevent_email_action'>
}
