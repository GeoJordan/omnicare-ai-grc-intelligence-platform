 ...
 */
type CatalogItemConfig<V extends VariableTypes = VariableTypes> = Now.Internal.WithIdAndMetadata<
...
>(config: CatalogItem<V> & { variableSets?: VSets }): CatalogItem<V> & { variables: MergedVariables<V, VSets> }
// biome-ignore lint/suspicious/noRedeclare: function overloads require redeclaration
export function CatalogItem(config: CatalogItem): CatalogItem
export function CatalogItem(config: CatalogItem) {
    return config
}
