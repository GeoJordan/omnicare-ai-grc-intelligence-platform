 ...
 * @interface
 */
export type CatalogUiPolicyProps = Now.Internal.WithIdAndMetadata<CatalogUiPolicyConfig>
 ...
 *
 * @param config Catalog UI Policy configuration — condition, actions, target item or variable set.
