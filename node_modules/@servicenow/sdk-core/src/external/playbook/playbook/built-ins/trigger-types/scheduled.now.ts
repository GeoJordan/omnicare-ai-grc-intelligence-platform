...
// Source: @servicenow/sdk-playbook-plugin/src/api/playbook/built-ins/trigger-types/scheduled.now.ts
import { PlaybookTriggerType } from '../../PlaybookTriggerTypes.js'
import {
    ChoiceColumn,
    ConditionsColumn,
    DateTimeColumn,
...
export const Scheduled = PlaybookTriggerType({
    $id: 'd249fae6ff3f12108f25ffffffffff89',
    label: 'Scheduled',
    inputs: {
        table: TableNameColumn({ label: 'Table', sysId: '12d6b834ff5022108f25ffffffffff70', columnType: 'string' }),
        condition: ConditionsColumn({
            label: 'Condition',
            sysId: 'b927b074ff5022108f25ffffffffff5c',
            columnType: 'string',
        }),
        startDateAndTime: DateTimeColumn({
            label: 'Start Date and Time',
            sysId: 'ddd78be6ff7f12108f25ffffffffffb5',
            columnType: 'string',
        }),
        recurrence: ChoiceColumn({
            label: 'Repeat',
            choices: {
        ...
        frequency: IntegerColumn({ label: 'Every', sysId: '6d4cfa6eff3f12108f25ffffffffff0e', columnType: 'number' }),
        /** Used with monthly and yearly recurrence. Fixed day uses dayOfMonth; relative weekday uses relativeWeek + relativeWeekday. */
        daySelection: ChoiceColumn({
            label: 'On',
            choices: {
        ...
        endDateTime: DateTimeColumn({
            label: 'Date and Time',
            sysId: '445d72eeff3f12108f25ffffffffff41',
            columnType: 'string',
        }),
        /** Max number of times the trigger can run. */
        limit: IntegerColumn({ label: 'Limit', sysId: '3b09b4f4ff5022108f25ffffffffff88', columnType: 'number' }),
