 ...
 */
export const COMPLEX_OBJECT_TYPE: globalThis.Record<string, string> = {
    FlowObject: 'object',
...
export function extractTriggerOutputs(
    ...
    for (const [outputName, outputValue] of outputsObj.entries()) {
        ...
        const internalType = COLUMN_API_TO_TYPE[columnApiName] || COMPLEX_OBJECT_TYPE[columnApiName] || columnApiName
        if (!internalType) {
            continue
        }
