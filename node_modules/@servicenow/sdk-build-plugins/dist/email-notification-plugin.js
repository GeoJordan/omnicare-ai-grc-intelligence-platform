                        ...
                        elements.forEach((element, index) => {
                            if (element.isRecord()) {
                                ...
                                if ((0, sdk_build_core_1.isGUID)(str)) {
                                    ...
                                    (0, utils_1.showGuidFieldDiagnostic)(element, `recipientDetails.recipientGroups[${index}]`, 'sys_user_group', diagnostics);
                                }
                            }
                        });
                        ...
                        elements.forEach((element, index) => {
                            if (element.isRecord()) {
                                ...
                                if ((0, sdk_build_core_1.isGUID)(str)) {
                                    ...
                                    (0, utils_1.showGuidFieldDiagnostic)(element, `emailContent.pushMessageList[${index}]`, 'sys_push_notif_msg', diagnostics);
                                }
                            }
                        });
                    ...
                    if (templateArg) {
                        if (templateArg.isRecord()) {
                            ...
                            if ((0, sdk_build_core_1.isGUID)(templateStr)) {
                                ...
                                (0, utils_1.showGuidFieldDiagnostic)(templateArg, 'emailContent.template', 'sysevent_email_template', diagnostics);
                            }
                        }
                    }
                }
                    ...
                    if (styleArg) {
                        if (styleArg.isRecord()) {
                            ...
                            if ((0, sdk_build_core_1.isGUID)(styleStr)) {
                                ...
                                (0, utils_1.showGuidFieldDiagnostic)(styleArg, 'emailContent.style', 'sysevent_email_style', diagnostics);
                            }
                        }
                    }
                }
                    ...
                    if (defaultIntervalArg) {
                        if (defaultIntervalArg.isRecord()) {
                            ...
                            if ((0, sdk_build_core_1.isGUID)(defaultIntervalStr)) {
                                ...
                                (0, utils_1.showGuidFieldDiagnostic)(defaultIntervalArg, 'digest.defaultInterval', 'sys_email_digest_interval', diagnostics);
                            }
                        }
                    }
                }
                    ...
                    if (digestTemplateArg) {
                        if (digestTemplateArg.isRecord()) {
                            ...
                            if ((0, sdk_build_core_1.isGUID)(digestTemplateStr)) {
                                ...
                                (0, utils_1.showGuidFieldDiagnostic)(digestTemplateArg, 'digest.template', 'sysevent_email_template', diagnostics);
                            }
                        }
                    }
                }
                ...
                if (categoryArg) {
                    if (categoryArg.isRecord()) {
                        ...
                        if ((0, sdk_build_core_1.isGUID)(categoryStr)) {
                            ...
                            (0, utils_1.showGuidFieldDiagnostic)(categoryArg, 'category', 'sys_notification_category', diagnostics);
                        }
                    }
                }
