...
exports.LocalModuleLint = exports.Lint = void 0;
...
let localModuleConfig;
function getSharedLinter() {
    if (!sharedLinter) {
        sharedLinter = new eslint_1.Linter({ configType: 'eslintrc' });
        sharedLinter.defineRules((0, Rules_1.getPluginRules)());
        dependencyConfig = (0, Rules_1.getEslintConfig)();
        localModuleConfig = (0, Rules_1.getLocalModuleEslintConfig)();
    }
    return sharedLinter;
}
function outputLintingResults(messages) {
    const stats = messages.reduce((result, message) => {
        if (message.fatal) {
    ...
    return eslint_formatter_stylish_1.default([results]);
}
/**
...
exports.LocalModuleLint = LocalModuleLint;
