...
function determineRootIdentifierAndPath(propertyNames, diagnostics, propertyAccessShape) {
    ...
    switch (propertyNames[1]) {
        case 'inputs': {
            ...
            const actionAncestor = (0, utils_2.findAncestorByCalleeName)(propertyAccessShape.getOriginalNode(), 'Action');
        ...
        },
        {
            ...
            async toSubclass(shape, { transform }) {
                ...
                for (const span of shape.getSpans()) {
                    ...
                    const pillShape = expr.is([sdk_build_core_1.PropertyAccessShape, sdk_build_core_1.IdentifierShape])
