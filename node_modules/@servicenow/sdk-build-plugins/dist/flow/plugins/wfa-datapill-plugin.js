    ...
    nodes: [
        {
            ...
            async toShape(node, { diagnostics, transform }) {
                ...
                const isDataPillAncestorValid = (0, utils_2.findAncestorByCalleeName)(node, 'Flow', 'Subflow', 'Action');
                if (!isDataPillAncestorValid) {
                    diagnostics.error(node, 'wfa.dataPill() cannot be used outside of a Flow, Subflow, or Action context.');
                    return { success: false };
                }
                ...
                const actionAncestor = (0, utils_2.findAncestorByCalleeName)(node, 'Action');
                if (actionAncestor) {
                    diagnostics.hint(expressionArg, 'wfa.dataPill: expression could not be resolved at compile time. ' +
