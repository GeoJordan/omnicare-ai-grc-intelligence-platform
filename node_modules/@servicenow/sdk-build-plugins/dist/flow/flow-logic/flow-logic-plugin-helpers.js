...
exports.FlowLogicValueProcessor = void 0;
...
exports.isAppendToFlowVariablesShape = isAppendToFlowVariablesShape;
...
(function (FlowLogicValueProcessor) {
    ...
    const INPUT_VALUE_PREPARERS = {
        ...
        [flow_logic_constants_1.FLOW_LOGIC.APPEND_TO_FLOW_VARIABLES]: (data) => {
            return prepareSetFlowVariables(data.asObject(), '');
        },
    ...
    function prepare(logicType, data, args) {
        ...
        return {
            ...
            variables: logicType === flow_logic_constants_1.FLOW_LOGIC.SET_FLOW_VARIABLES || logicType === flow_logic_constants_1.FLOW_LOGIC.APPEND_TO_FLOW_VARIABLES
    ...
    const VALUE_PARSERS = {
        ...
        [flow_logic_constants_1.FLOW_LOGIC.APPEND_TO_FLOW_VARIABLES]: () => ({}),
    ...
    function parse(logicType, gZippedString, typeMap, labelCacheMap) {
        ...
        if (logicType === flow_logic_constants_1.FLOW_LOGIC.SET_FLOW_VARIABLES || logicType === flow_logic_constants_1.FLOW_LOGIC.APPEND_TO_FLOW_VARIABLES) {
     ...
     */
    function processPureDatapill(value, _labelCacheMap) {
     ...
     */
    function processTemplateExpression(value, _labelCacheMap) {
    ...
    function parseChildrenArray(children, elementType, nestedTypeMap, complexObjectData, labelCacheMap) {
        ...
        const allSameName = children.length >= minChildrenForArray &&
            children.every((c) => {
                const entry = c;
...
})(FlowLogicValueProcessor || (exports.FlowLogicValueProcessor = FlowLogicValueProcessor = {}));
/**
...
function isAppendToFlowVariablesShape(expr) {
    return expr.getCallee() === flow_logic_constants_1.FLOW_LOGIC.APPEND_TO_FLOW_VARIABLES;
}
...
const FLOW_LOGIC_ARGUMENT_BUILDERS = {
    ...
    [flow_logic_constants_1.FLOW_LOGIC.APPEND_TO_FLOW_VARIABLES]: buildAppendToFlowVariablesArguments,
 ...
 */
function buildAppendToFlowVariablesArguments(record, _logicBodyShapes, database) {
    return buildVariableOrOutputArguments(record, database, 'sys_hub_flow_variable', flow_logic_constants_1.FLOW_LOGIC.APPEND_TO_FLOW_VARIABLES, '{{flowVariables}}');
}
/**
...
function getFallbackParameterName(record) {
    ...
    return order ? `item_${(0, utils_1.getOrderSuffix)(order)}` : 'item';
}
