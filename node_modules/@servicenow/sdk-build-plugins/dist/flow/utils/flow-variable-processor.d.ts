 ...
 */
export declare function processVariableConfig(config: ObjectShape | undefined, varTable: VariableTableType, parentRecord: Record, factory: Factory, diagnostics: Diagnostics, parentTable?: ParentTableType): Promise<Record[]>;
/**
 ...
 */
export declare function processFlowInputs(inputsConfig: ObjectShape | undefined, parentRecord: Record, factory: Factory, diagnostics: Diagnostics, parentTable?: ParentTableType): Promise<Record[]>;
/**
 ...
 */
export declare function processFlowOutputs(outputsConfig: ObjectShape | undefined, parentRecord: Record, factory: Factory, diagnostics: Diagnostics, parentTable?: ParentTableType): Promise<Record[]>;
/**
 ...
 */
export declare function processFlowVariables(flowVariablesConfig: ObjectShape | undefined, parentRecord: Record, factory: Factory, diagnostics: Diagnostics, parentTable?: ParentTableType): Promise<Record[]>;
