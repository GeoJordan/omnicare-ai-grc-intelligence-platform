...
import { PillShape } from './data-pill-shapes';
...
export declare const getBuiltInStepIdentifier: (sysId: string) => string | undefined;
/**
 ...
 */
export declare function getOrderSuffix(rawOrder: string): string;
