    ...
    shapes: [
        ...
        },
        {
            ...
            async toRecord(callExpression, { diagnostics, factory }) {
                ...
                const cssIncludes = await (0, utils_2.getIncludeRecords)(dependency.get('cssIncludes'), dependencyRecord.getId(), factory, 'm2m_sp_dependency_css_include', 'sp_css_include', 'sp_dependency', diagnostics);
                const jsIncludes = await (0, utils_2.getIncludeRecords)(dependency.get('jsIncludes'), dependencyRecord.getId(), factory, 'm2m_sp_dependency_js_include', 'sp_js_include', 'sp_dependency', diagnostics);
                return {
                    success: true,
