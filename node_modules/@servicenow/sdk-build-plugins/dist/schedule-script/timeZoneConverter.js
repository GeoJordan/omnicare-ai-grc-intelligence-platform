...
exports.dateTimeFieldToXML = dateTimeFieldToXML;
exports.convertXMLToDateTime = convertXMLToDateTime;
exports.formatTimeDataToDateTime = formatTimeDataToDateTime;
/**
 ...
 */
function formatToUTC(date = new Date()) {
...
function dateTimeFieldToXML(dateTimeStr, timeZone) {
    ...
    const targetTimeZone = timeZone === 'floating' || !timeZone ? Intl.DateTimeFormat().resolvedOptions().timeZone : timeZone;
 ...
 * // Returns '2026-03-02 09:00:00'
 */
function convertXMLToDateTime(utcDateTimeStr, timeZone) {
 ...
 */
function formatTimeDataToDateTime(timeData) {
