...
async function buildVariableRecords(options) {
    ...
    for (const [k, v] of entries) {
        ...
        if (calleeName === variable_helper_2.VariableTypeName.CHECKBOX) {
            (0, service_catalog_diagnostics_1.validateSelectionRequiredReadOnlyHidden)(config, diagnostics);
        }
        else if (calleeName !== variable_helper_2.VariableTypeName.BREAK &&
            calleeName !== variable_helper_2.VariableTypeName.CONTAINER_END &&
            calleeName !== variable_helper_2.VariableTypeName.CONTAINER_SPLIT &&
        ...
        const props = callExpr
            ...
            mandatory: calleeName === variable_helper_2.VariableTypeName.CHECKBOX
