...
`C & RadioColumnType<TChoices, Type, Default>`
...
- **choices** (optional): `Record<string | number, string | ChoiceConfig>`
  Choice values for this field. Keys are the stored values; values are either a display label string or a ChoiceConfig object.
