...
1. **Component Library:** Use `@servicenow/react-components` for all UI elements. Before writing UI code, consult the component documentation shipped with the package (under its `docs/` directory).
