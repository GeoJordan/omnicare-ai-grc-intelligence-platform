...
exports.RecordId = exports.Record = exports.VariableStatementShape = exports.ElementAccessExpressionShape = exports.SourceFileShape = exports.CallExpressionShape = exports.ObjectShape = exports.ShapeTransform = exports.ArrayShape = exports.BooleanShape = exports.NumberShape = exports.TaggedTemplateExpressionShape = exports.TemplateExpressionShape = exports.TemplateSpanShape = exports.StringLiteralShape = exports.StringShape = exports.PropertyAccessShape = exports.IdentifierShape = exports.ResolvableShape = exports.DeletedShape = exports.UndefinedShape = exports.UnresolvedShape = exports.NoOpShape = exports.Shape = void 0;
exports.getInstallCategoryFromPath = getInstallCategoryFromPath;
exports.getInstallCategory = getInstallCategory;
exports.isLazyValue = isLazyValue;
...
exports.ShapeTransform = ShapeTransform;
...
class ObjectShape extends Shape {
    ...
    properties({ nonDefaultsOnly = false, resolve = true, keys = undefined, } = {}) {
        const result = {};
    ...
    pick(properties, options = {}) {
        ...
        return Object.fromEntries(this.entries({ ...options, keys: properties })
            .filter(([k]) => regex.test(k))
            .map(([k, v]) => [k, v]));
    }
...
class CallExpressionShape extends Shape {
    ...
    args;
    exportName;
    constructor({ source, callee, args, exportName, }) {
        super({ source });
        this.callee = callee;
    ...
    getExportName() {
        if (this.exportName) {
            return _.camelCase(this.exportName);
        }
        return undefined;
    }
    hasExportName() {
...
class SourceFileShape extends StringShape {
    path;
    content;
    constructor({ source, path, content }) {
        super({ source });
        this.path =
            typeof path === 'string'
                ? path
                : path.asString(`Source file path must be a string, but received: ${path.getDescription()}`).getValue();
        this.content =
            typeof content === 'string'
                ? content
                : content
                    .asString(`Source file content must be a string, but received: ${content.getDescription()}`)
                    .getValue();
    }
    getPath() {
        return this.path;
...
function getInstallCategoryFromPath(filePath) {
...
function getInstallCategory(source, table) {
    ...
    else if (source instanceof product_1.Product) {
...
class Record extends ObjectShape {
    ...
    //     return `${this.id.getTable()}_${this.id.getValue()}`
    // }
    with(...related) {
    ...
    /**
     * Returns a flattened array containing this record and all related records recursively.
     * Includes this record, its direct children, and all descendants.
     */
    flat() {
...
function isLazyValue(shape) {
    return typeof shape['evaluate'] === 'function';
}
function hasAssociatedRecords(shape) {
    return typeof shape['createAssociatedRecords'] === 'function';
}
