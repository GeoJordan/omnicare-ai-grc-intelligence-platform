...
exports.taxonomy = exports.taxonomySchemaDefault = void 0;
...
const taxonomyMapping = z
    ...
    [TableNames.SYS_CLIENT_EXTENSION_INSTANCE]: taxonomyItem.default('client-development/client-extension-instance'),
    ...
    [TableNames.ECC_AGENT_CAPABILITY_VALUE_TEST]: taxonomyItem.default('mid-server/mid-server-capability-value-test'),
    // Mobile tables
    ...
    .default({});
exports.taxonomySchemaDefault = taxonomyMapping.parse({});
exports.taxonomy = z
    .object({
    ...
    const mappingWithDefaults = new Proxy(data.mapping || {}, {
        get(target, prop) {
            if (typeof prop === 'string' && !(prop in target)) {
                ...
                return `${data.fallbackFolderName}/${(0, kebabCase_1.default)(prop)}`;
            }
